...
const wrapper = ({ children, initialRoute = '/' }: { children: React.ReactNode; initialRoute?: string }) => (
...
describe('useCatalogViewState', () => {
  ...
  it('should initialize with custom initial view', () => {
    const { result } = renderHook(() => useCatalogViewState('cards'), { wrapper });
  ...
  it('should read view from URL parameter', () => {
    ...
    const { result } = renderHook(() => useCatalogViewState(), { wrapper: TestWrapper });
  ...
  it('should toggle between table and cards view', () => {
    const { result } = renderHook(() => useCatalogViewState('table'), { wrapper });
